...
function ContractTab() {
  ...
  const S = {
    ...
    input: { padding: "9px 11px", border: "1.5px solid #E0D5C5", borderRadius: 6, fontSize: 13, fontFamily: "inherit", outline: "none", background: "#FFFDF9", color: "#2D2016", width: "100%" },
  };
...
body { font-family: 'Malgun Gothic', sans-serif; font-size: 11pt; line-height: 1.6; color: #000; padding: 20px; }
h1 { text-align: center; font-size: 20pt; font-weight: bold; margin-bottom: 30px; border-bottom: 3px solid #000; padding-bottom: 10px; }
.section { margin-bottom: 20px; }
.section-title { font-size: 12pt; font-weight: bold; margin-bottom: 10px; padding: 5px 10px; background: #f0f0f0; border-left: 4px solid #333; }
table { width: 100%; border-collapse: collapse; margin-bottom: 15px; }
th, td { border: 1px solid #000; padding: 8px; text-align: left; }
th { background: #e8e8e8; font-weight: bold; width: 25%; }
.clause { margin-bottom: 15px; padding-left: 15px; }
.clause-title { font-weight: bold; margin-bottom: 5px; }
.signature { display: flex; justify-content: space-between; margin-top: 30px; page-break-inside: avoid; }
.signature-box { width: 48%; border: 2px solid #000; padding: 15px; }
.signature-box h3 { font-size: 12pt; font-weight: bold; margin-bottom: 10px; border-bottom: 1px solid #000; padding-bottom: 5px; }
.signature-line { margin: 8px 0; }
.print-btn { position: fixed; top: 20px; right: 20px; padding: 12px 24px; background: #333; color: #fff; border: none; border-radius: 5px; font-size: 14px; cursor: pointer; box-shadow: 0 2px 5px rgba(0,0,0,0.2); }
...
<p style="text-align:center; margin-bottom:25px; font-size:11pt;">
...
<div class="clause">
갑은 을에게 본 근로계약서를 서면으로 작성하여 교부한다.
</div>
</div>
...
<div class="clause">
갑과 을은 각자가 본 계약에서 정한 바를 성실히 이행하여야 한다.
</div>
</div>
...
<p style="text-align:center; font-size:11pt; margin:25px 0;">
...
<div class="signature-line" style="margin-top:30px; border-top:1px solid #999; padding-top:10px;"><strong>서명:</strong> ________________</div>
</div>
