...
body { font-family: 'Malgun Gothic', sans-serif; font-size: 9.5pt; line-height: 1.45; color: #000; padding: 14px; }
h1 { text-align: center; font-size: 17pt; font-weight: bold; margin-bottom: 13px; }
.intro { text-align: center; margin-bottom: 14px; font-size: 9.5pt; line-height: 1.5; }
.article { margin-bottom: 11px; }
.article-title { font-size: 10.5pt; font-weight: bold; margin-bottom: 6px; }
.content { font-size: 9.5pt; line-height: 1.5; padding-left: 3px; }
.content p { margin: 3px 0; }
.note { font-size: 8.5pt; line-height: 1.4; padding: 6px 9px; background: #f5f5f5; margin-top: 5px; border-left: 3px solid #666; }
.date-section { text-align: center; margin: 14px 0; font-size: 9.5pt; }
.signature-section { margin-top: 16px; }
.signature-box { margin-bottom: 12px; }
.signature-box h3 { font-size: 10.5pt; font-weight: bold; margin-bottom: 6px; border-bottom: 1.5px solid #000; padding-bottom: 3px; }
.signature-line { margin: 4px 0; font-size: 9.5pt; }
...
<div class="content">
<p>본 계약은 ${startY || "____"}년 ${startM || "__"}월 ${startD || "__"}일부터 ${endY || "____"}년 ${endM || "__"}월 ${endD || "__"}일까지 근로하는 것으로 한다. 기간이 정해지지 않으면 기간의 정함 없이 계속 근로하는 것으로 한다.</p>
</div>
</div>
...
<div class="content">
<p>• 근무장소: 팔팔너구리해장 신당본점 &nbsp;&nbsp; • 업무내용: 홀서빙, 청소 및 매장 기타(${c.extraTask || "       "})</p>
</div>
</div>
...
<div class="content">
<p>• 근로시간: ${c.workStart || "__:__"} ~ ${c.workEnd || "__:__"} &nbsp;&nbsp; • 휴게시간: ${c.breakStart || "__:__"} ~ ${c.breakEnd || "__:__"}</p>
<p>• 근무요일: ${workDaysText || "____________"} &nbsp;&nbsp; • 주 근무일수: ${c.workDaysCount || "__"}일 &nbsp;&nbsp; • 주 소정근로시간: 주 ${weeklyHours || "__"}시간</p>
</div>
</div>
...
<div class="content">
<p>• 시급: ${Number(c.wage || 0).toLocaleString()}원 &nbsp;&nbsp; • 임금지급일: 익월 10일 &nbsp;&nbsp; • 지급방법: 을의 예금계좌로 입금</p>
</div>
</div>
...
<div class="content">
<p>사업장 운영 상황에 따라 근무일 및 근로시간은 변경될 수 있으며, 이 경우 갑은 을에게 최소 1일 전까지 문자 또는 메신저 등으로 사전 통보 및 협의한다. 다만, 근로자의 동의 없이 주 소정근로시간을 상시적으로 변경할 수 없다.</p>
</div>
</div>
...
<div class="note">※ 본 사업장은 상시근로자 5인 미만 사업장으로, 연장·야간·휴일근로 가산수당은 법 적용 제외 대상임.</div>
</div>
</div>
...
<h3>[사업주]</h3>
<div class="signature-line">상호: 팔팔너구리해장 &nbsp;&nbsp; 대표자: 양두환, 박지현</div>
<div class="signature-line">주소: 서울특별시 중구 퇴계로 421 1층 2호 &nbsp;&nbsp; 서명: ____________</div>
</div>

<div class="signature-box">
<h3>[근로자]</h3>
<div class="signature-line">성명: ${c.empName || "____________"} &nbsp;&nbsp; 연락처: ${c.empPhone || "____________"}</div>
<div class="signature-line">주소: ${c.empAddr || "____________________________________________"} &nbsp;&nbsp; 서명: ____________</div>
</div>
</div>
